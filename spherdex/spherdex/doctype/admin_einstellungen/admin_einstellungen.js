...
function addCustomButtons(frm, position) {
    ...
    deleteButton.on('click', () => {
        frappe.confirm('Alle Protokolleinträge wirklich löschen?', () => {
            frappe.call({
                method: 'spherdex.global_scripts.utils.clear_protokoll',
                callback: function() {
...
function loadProtokoll(frm, limit, page) {
    frappe.call({
        method: 'spherdex.global_scripts.utils.get_protokoll',
        ...
        callback: function(response) {
            ...
            frappe.run_serially([
                () => frm.clear_table("sperr_protokoll"), // 🔥 Verhindert UI-Änderungen am Doctype
                () => {
